$(document).on('ready', function() {
	...
	function disabledInputDatosCliente(flag) {
		if(flag) {
			...
			$('#codigoComprobante').attr('disabled', true);
			$('#cantidadPago').attr('disabled', true);
			$('#documentoPersonaPago').attr('disabled', true);
			$('#realizarPagoCliente').attr('disabled', true);
		}
		else {
			...
			$('#codigoComprobante').attr('disabled', false);
			$('#cantidadPago').attr('disabled', false);
			$('#documentoPersonaPago').attr('disabled', false);
			$('#realizarPagoCliente').attr('disabled', false);
		}
	}
