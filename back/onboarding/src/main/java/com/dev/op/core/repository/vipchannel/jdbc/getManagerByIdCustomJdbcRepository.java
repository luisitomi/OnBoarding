...
import com.dev.op.core.mapper.vipchannel.getManagerByIdMapper;
import com.dev.op.core.util.vipchannel.Constantes;

@Repository("getManagerByIdJdbcRepository")
public class getManagerByIdCustomJdbcRepository implements getManagerByIdJdbcRepository {
	...
	public List<getManagerByIdModel> getManagerById(String document,String code) {
		...
		try {
			...
			simpleJdbcCall.withProcedureName(Constantes.GETMANAGERBYID);
			simpleJdbcCall.declareParameters(new SqlParameter("document", Types.VARCHAR),
											 new SqlParameter("code", Types.VARCHAR));
			simpleJdbcCall.returningResultSet("getManagerById", new getManagerByIdMapper());
			...
			getManagerById = (List<getManagerByIdModel>) result.get("getManagerById");
