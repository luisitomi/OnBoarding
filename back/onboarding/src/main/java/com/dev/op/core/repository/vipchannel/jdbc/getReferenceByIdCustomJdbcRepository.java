...
import com.dev.op.core.mapper.vipchannel.getReferenceByIdMapper;
import com.dev.op.core.util.vipchannel.Constantes;

@Repository("getReferenceByIdJdbcRepository")
public class getReferenceByIdCustomJdbcRepository implements getReferenceByIdJdbcRepository {
	...
	public List<getReferenceByIdModel> getReferenceById(String document,String code) {
		...
		try {
			...
			simpleJdbcCall.withProcedureName(Constantes.GETREFERENCEBYID);
			simpleJdbcCall.declareParameters(new SqlParameter("document", Types.VARCHAR),
											 new SqlParameter("code", Types.VARCHAR));
			simpleJdbcCall.returningResultSet("getReferenceById", new getReferenceByIdMapper());
			...
			getReferenceById = (List<getReferenceByIdModel>) result.get("getReferenceById");
